...
class StoryArcDetailsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> players =
        phase['key_players'] is List ? phase['key_players'] : [];
    final String? pos = phase['contrarian_pos'];
    final String? neg = phase['contrarian_neg'];
    final List<dynamic> linkedArticles =
        phase['linked_articles'] is List ? phase['linked_articles'] : [];
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(
                            height: 80), // Extra space for FAB and bottom
                      ],
                    ),
                  ),
                ],
            ...
            // FIXED CLOSE BUTTON - PLACED LAST IN STACK
            Positioned(
              top: 15,
              right: 15,
              child: GestureDetector(
                ...
                onTap: () {
                  print("StoryArcDetailsSheet: CLOSE BUTTON TAPPED");
